...
/* ── Header — keep visible so sidebar toggle is never lost ── */
...
/* ── Sidebar toggle — every known selector ── */
...
@media (max-width: 768px) {
    ...
    .lp-value-grid { grid-template-columns: 1fr 1fr !important; gap: 0.6rem !important; }
    .lp-trust-strip { flex-direction: column !important; gap: 0.5rem !important; }
}
...
.stRadio > div > label:hover { border-color: var(--gold) !important; color: var(--text) !important; }
...
.alert-critical {
    ...
    border-radius: 10px; padding: 0.75rem 1rem; margin-bottom: 0.5rem;
    color: var(--ruby); font-size: 0.85rem;
}
.alert-success {
...
.stock-low     { background: rgba(245,158,11,0.1); color: var(--amber); padding: 3px 10px; border-radius: 99px; font-size: 0.72rem; font-weight: 600; border: 1px solid rgba(245,158,11,0.2); }
...
[data-testid="stForm"] { background: var(--surface2) !important; border: 1px solid var(--border) !important; border-radius: 16px !important; padding: 1.5rem !important; }
...
/* ── Forgot password ── */
.forgot-link { font-size: 0.82rem; color: var(--gold); text-decoration: none; cursor: pointer; font-weight: 500; }

/* ── Pricing Cards ── */
.pricing-grid { display: flex; gap: 1.25rem; justify-content: center; flex-wrap: wrap; margin: 2rem 0; }
.pricing-card {
    background: var(--surface2);
    border: 1px solid var(--border2);
    border-radius: 18px;
...
.pricing-card.featured {
    ...
    box-shadow: 0 32px 64px rgba(245,166,35,0.1), 0 0 0 1px var(--gold);
}
.pricing-badge { position: absolute; top: -13px; left: 50%; transform: translateX(-50%); background: var(--gold); color: #080b12; font-size: 0.62rem; font-weight: 800; padding: 4px 14px; border-radius: 99px; text-transform: uppercase; letter-spacing: 0.1em; white-space: nowrap; }
.pricing-plan-name { font-size: 0.7rem; font-weight: 700; letter-spacing: 0.15em; text-transform: uppercase; color: var(--muted); margin-bottom: 0.75rem; font-family: var(--font-mono); }
.pricing-price { font-size: 2.2rem; font-weight: 700; color: var(--text); font-family: var(--font-mono); line-height: 1; letter-spacing: -0.03em; }
.pricing-price span { font-size: 0.9rem; font-weight: 400; color: var(--muted); }
.pricing-desc { font-size: 0.78rem; color: var(--muted); margin: 0.5rem 0 1.25rem 0; }
.pricing-features { list-style: none; padding: 0; margin: 0 0 1.5rem 0; text-align: left; }
.pricing-features li { font-size: 0.82rem; color: var(--text); padding: 0.4rem 0; border-bottom: 1px solid var(--border); display: flex; align-items: center; gap: 0.5rem; }
.pricing-features li:last-child { border-bottom: none; }
.pricing-features li::before { content: "✓"; color: var(--jade); font-weight: 700; flex-shrink: 0; }

/* ── Login landing page ── */
.lp-hero { text-align: center; padding: 2.5rem 1rem 1.5rem 1rem; }
.lp-logo-wrap { display: inline-flex; align-items: center; gap: 0.75rem; margin-bottom: 1.25rem; }
.lp-logo-icon { width: 52px; height: 52px; border-radius: 14px; background: linear-gradient(135deg, var(--gold), #C4831A); display: flex; align-items: center; justify-content: center; font-size: 1.6rem; box-shadow: 0 8px 28px rgba(245,166,35,0.4); }
.lp-logo-text { font-family: var(--font-body); font-size: 2.2rem; font-weight: 800; color: var(--text); letter-spacing: -0.05em; }
.lp-badge { display: inline-flex; align-items: center; gap: 0.45rem; background: rgba(245,166,35,0.1); border: 1px solid rgba(245,166,35,0.3); border-radius: 99px; padding: 0.35rem 1rem; font-size: 0.75rem; color: var(--gold); font-weight: 600; letter-spacing: 0.04em; margin-bottom: 1.25rem; }
.lp-headline { font-family: var(--font-body); font-size: clamp(1.7rem,5vw,2.6rem); font-weight: 800; color: var(--text); letter-spacing: -0.04em; line-height: 1.15; margin-bottom: 0.75rem; }
.lp-headline span { color: var(--gold); }
.lp-sub { font-size: 1rem; color: var(--muted); max-width: 520px; margin: 0 auto 1.75rem auto; line-height: 1.65; }
.lp-value-grid { display: grid; grid-template-columns: repeat(4,1fr); gap: 0.75rem; max-width: 720px; margin: 0 auto 2rem auto; }
.lp-value-card { background: var(--surface2); border: 1px solid var(--border); border-radius: 14px; padding: 1.1rem 1rem; text-align: center; transition: border-color 0.2s; }
.lp-value-card:hover { border-color: var(--gold); }
.lp-value-icon { font-size: 1.5rem; margin-bottom: 0.4rem; }
.lp-value-title { font-family: var(--font-body); font-size: 0.8rem; font-weight: 700; color: var(--text); margin-bottom: 0.2rem; }
.lp-value-desc { font-size: 0.72rem; color: var(--muted); line-height: 1.4; }
.lp-divider { display: flex; align-items: center; gap: 1rem; max-width: 480px; margin: 0 auto 1.5rem auto; }
.lp-divider::before, .lp-divider::after { content: ''; flex: 1; border-top: 1px solid var(--border); }
.lp-divider span { font-size: 0.75rem; color: var(--muted); white-space: nowrap; }
.lp-trust-strip { display: flex; justify-content: center; align-items: center; gap: 1.5rem; flex-wrap: wrap; padding: 1rem 0; border-top: 1px solid var(--border); margin-top: 1rem; }
.lp-trust-item { display: flex; align-items: center; gap: 0.4rem; font-size: 0.75rem; color: var(--muted); }
.lp-trust-item span { color: var(--jade); }
...
.fade-in-4 { animation: fadeSlideUp 0.45s ease 0.3s both; }
